<?php
	...
	// get book data
	$query = "SELECT * FROM comedy WHERE show_id = '$show_id'";
...
?>
	<form method="post" action="edit_comedy.php" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<th>Show_id</th>
			...
			<tr>
				<th>Link</th>
				<td><input type="text" name="price" value="<?php echo $row['show_link'];?>" required></td>
			</tr>
		</table>

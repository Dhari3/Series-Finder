<?php
	...
	if(isset($_POST['add'])){
		...
		$query = "INSERT INTO action1 VALUES ('" . $isbn . "', '" . $title . "', '" . $author . "', '" . $image . "', '" . $descr . "', '" . $price . "')";
...
?>
	<form method="post" action="admin_add_action.php" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<th>Show_id</th>
			...
			<tr>
				<th>Image</th>
				<td><input type="url" name="show_img" required></td>
			</tr>
			<tr>
				<th>Description</th>
